...
{
	controls->tvel[Y] = joystick_parsing->controls->rpy[ROLL] * MAX_JOYSTICK_RANGE*10; //?
	controls->tvel[X] = -joystick_parsing->controls->rpy[PITCH] * MAX_JOYSTICK_RANGE*10; //?
	controls->tvel[Z] = -joystick_parsing->controls->thrust*1.5* MAX_JOYSTICK_RANGE; //?
