/** @file
 *	@brief MAVLink comm protocol testsuite generated from maveric2.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef MAVERIC2_TESTSUITE_H
#define MAVERIC2_TESTSUITE_H
...
static void mavlink_test_maveric2(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

	mavlink_test_maveric2(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_maveric2(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
